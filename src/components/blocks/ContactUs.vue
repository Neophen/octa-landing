  ...
  <div id="book-a-demo" class="grid grid-cols-1 gap-24 pt-40 mx-auto md:grid-cols-2">
    ...
    <div>
      ...
      <form class="mt-5 space-y-5" @submit.prevent="onSubmit">
        <label class="block">
          <span class="mb-2 ml-3 text-sm text-gray-500 font-text">Full name</span>
          <input
            v-model="full_name"
            name="full_name"
            type="text"
        ...
        <label class="block">
          <span class="mb-2 ml-3 text-sm text-gray-500 font-text">Work e-mail</span>
          <input
            type="email"
            name="email"
            v-model="email"
        ...
        <label class="block">
          <span class="mb-2 ml-3 text-sm text-gray-500 font-text">Message</span>
          <textarea
            name="message"
            v-model="message"
