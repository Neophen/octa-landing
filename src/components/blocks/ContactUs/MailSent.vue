<template>
  <div
    v-if="showModal"
    class="fixed inset-0 z-50 flex items-center justify-center w-full h-screen bg-teal-100 bg-opacity-75 overflow-hidded"
  >
    <div
      class="flex flex-col items-center w-full h-screen p-16 text-center bg-white shadow-2xl md:rounded-modal md:w-auto md:h-auto"
      :class="
        animateModalUpDown
